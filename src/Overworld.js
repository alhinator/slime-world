class Overworld extends Phaser.Scene {
    ...
    create() {
        ...
        treeLayer.setCollisionByProperty({collideable: true})
        terrainLayer.setCollisionByProperty({collideable: true})
        ...
        this.cameras.main.startFollow(this.slime, false, 1, 1)
